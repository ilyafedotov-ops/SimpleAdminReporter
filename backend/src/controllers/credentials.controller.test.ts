...
describe("CredentialsController", () => {
  ...
  beforeEach(() => {
    ...
    router.get(
      "/defaults",
      credentialsController.getDefaultCredentials.bind(credentialsController),
    );
    router.get(
      "/:id",
      credentialsController.getCredential.bind(credentialsController),
    );
    router.post(
      "/",
      credentialsController.createCredential.bind(credentialsController),
    );
    router.put(
      "/:id",
      credentialsController.updateCredential.bind(credentialsController),
    );
    router.delete(
      "/:id",
      credentialsController.deleteCredential.bind(credentialsController),
    );
    router.post(
      "/:id/test",
      credentialsController.testCredential.bind(credentialsController),
    );
    router.put(
      "/:id/default",
      credentialsController.setDefaultCredential.bind(credentialsController),
    );
  ...
  describe("GET /api/credentials", () => {
    it("should return all credentials for authenticated user", async () => {
      ...
      expect(credentialsService.getUserCredentials).toHaveBeenCalledWith(
        1,
        undefined,
      );
    });
    ...
    it("should handle service errors", async () => {
      ...
      const response = await request(app).get("/api/credentials").expect(500);
    ...
    it("should only return credentials for authenticated user", async () => {
      ...
      expect(credentialsService.getUserCredentials).not.toHaveBeenCalledWith(
        2,
        undefined,
      );
    });
  ...
  describe("GET /api/credentials/:id", () => {
    it("should return specific credential for authenticated user", async () => {
      ...
      const response = await request(app).get("/api/credentials/1").expect(200);
    ...
    it("should enforce user ownership - user cannot access other users credentials", async () => {
      ...
      await request(app).get("/api/credentials/1").expect(404);
    ...
    it("should handle invalid credential ID format", async () => {
      ...
      await request(app).get("/api/credentials/invalid").expect(404);
    ...
    it("should handle service errors", async () => {
      ...
      const response = await request(app).get("/api/credentials/1").expect(500);
  ...
  describe("POST /api/credentials", () => {
    ...
    it("should create AD credential successfully", async () => {
      ...
      (credentialsService.createCredential as jest.Mock).mockResolvedValue(
        createdCredential,
      );
    ...
    it("should validate required fields for AD credentials", async () => {
      mockValidationResult.mockReturnValue({
        ...
        array: () => [
          {
            msg: "Username and password are required for AD credentials",
            param: "serviceType",
          },
        ],
      } as any);
    ...
    it("should validate required fields for Azure credentials", async () => {
      mockValidationResult.mockReturnValue({
        ...
        array: () => [
          {
            msg: "Tenant ID, Client ID, and Client Secret are required for Azure credentials",
            param: "serviceType",
          },
        ],
      } as any);
  ...
  describe("PUT /api/credentials/:id", () => {
    ...
    it("should update credential successfully", async () => {
      ...
      (credentialsService.updateCredential as jest.Mock).mockResolvedValue(
        updatedCredential,
      );
    ...
    it("should enforce user ownership on update", async () => {
      const error = Object.assign(new Error("Credential not found"), {
        statusCode: 404,
      });
      (credentialsService.updateCredential as jest.Mock).mockRejectedValue(
        error,
      ...
      await request(app).put("/api/credentials/1").send(updateData).expect(404);
  ...
  describe("DELETE /api/credentials/:id", () => {
    it("should delete credential successfully", async () => {
      (credentialsService.deleteCredential as jest.Mock).mockResolvedValue(
        undefined,
      );
    ...
    it("should enforce user ownership on deletion", async () => {
      ...
      await request(app).delete("/api/credentials/1").expect(404);
    ...
    it("should handle cascade deletion of related records", async () => {
      ...
      await request(app).delete("/api/credentials/1").expect(200);
  ...
  describe("POST /api/credentials/:id/test", () => {
    ...
    it("should test credential successfully", async () => {
      ...
      expect(logger.info).toHaveBeenCalledWith(
        "User 1 tested credential 1: true",
      );
    });
    ...
    it("should handle failed credential test", async () => {
      ...
      expect(logger.info).toHaveBeenCalledWith(
        "User 1 tested credential 1: false",
      );
    });
    ...
    it("should enforce user ownership on test", async () => {
      ...
      await request(app).post("/api/credentials/1/test").expect(404);
  ...
  describe("PUT /api/credentials/:id/default", () => {
    it("should set credential as default successfully", async () => {
      (credentialsService.setDefaultCredential as jest.Mock).mockResolvedValue(
        undefined,
      );
      ...
      expect(credentialsService.setDefaultCredential).toHaveBeenCalledWith(
        1,
        1,
      );
      expect(logger.info).toHaveBeenCalledWith(
        "User 1 set credential 1 as default",
      );
    });
    ...
    it("should enforce user ownership when setting default", async () => {
      ...
      await request(app).put("/api/credentials/1/default").expect(404);
  ...
  describe("GET /api/credentials/defaults", () => {
    it("should return default credentials for all service types", async () => {
      ...
      expect(credentialsService.getDefaultCredential).toHaveBeenCalledWith(
        1,
        "ad",
      );
      expect(credentialsService.getDefaultCredential).toHaveBeenCalledWith(
  ...
  describe("Authorization and Security", () => {
    it("should require authentication for all endpoints", async () => {
      ...
      const response = await request(appNoAuth).get("/test").expect(500); // Will error because req.user!.id is undefined
    ...
    it("should prevent user from accessing other users credentials", async () => {
      ...
      const response = await request(app).get("/api/credentials/1").expect(404);
  ...
  describe("Input Validation", () => {
    ...
    it("should validate credential name length", async () => {
      mockValidationResult.mockReturnValue({
        isEmpty: () => false,
        array: () => [
          { msg: "Credential name too long", param: "credentialName" },
        ],
      } as any);
    ...
    it("should validate boolean fields", async () => {
      mockValidationResult.mockReturnValue({
        isEmpty: () => false,
        array: () => [
          { msg: "isDefault must be a boolean", param: "isDefault" },
        ],
      } as any);
  ...
  describe("Error Handling", () => {
    ...
    it("should handle concurrent modification errors", async () => {
      ...
      expect(response.body.error).toBe(
        "Credential was modified by another process",
      );
    });
  });
  ...
  describe("Performance and Rate Limiting", () => {
    it("should handle multiple concurrent requests", async () => {
      ...
      const requests = Array(10)
        .fill(null)
        .map(() => request(app).get("/api/credentials"));
    ...
    it("should handle test credential rate limiting gracefully", async () => {
      ...
      const testRequests = Array(5)
        .fill(null)
        .map(() => request(app).post("/api/credentials/1/test"));
