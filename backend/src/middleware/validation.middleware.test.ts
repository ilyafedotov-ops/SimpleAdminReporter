...
describe("Validation Middleware", () => {
  ...
  describe("handleValidationErrors", () => {
    ...
    describe("Error Message Formatting", () => {
      ...
      it("should handle special characters in error messages", () => {
        ...
        expect(mockCreateError).toHaveBeenCalledWith(
          `Validation failed: ${specialMessage}`,
          400,
        );
      });
    });
  ...
  describe("sanitizeInput", () => {
    it("should HTML-escape unsafe markup from string values in body", () => {
      req.body = {
    ...
    it("should HTML-escape unsafe markup from query parameters", () => {
      req.query = {
    ...
    it("should HTML-escape unsafe markup from URL parameters", () => {
      req.params = {
        id: '123<script>alert("xss")</script>',
        category: "safe",
      };
    ...
    it("should HTML-escape complex script tag variations", () => {
      req.body = {
        content1: 'Hello<SCRIPT>alert("uppercase")</SCRIPT>World',
        content2:
          'Hello<script type="text/javascript">alert("typed")</script>World',
      ...
      expect(req.body).toEqual({
        content1:
          "Hello&lt;SCRIPT&gt;alert(&quot;uppercase&quot;)&lt;/SCRIPT&gt;World",
        content2:
          "Hello&lt;script type=&quot;text/javascript&quot;&gt;alert(&quot;typed&quot;)&lt;/script&gt;World",
        content3:
          "Hello&lt;script\nsrc=&quot;malicious.js&quot;&gt;&lt;/script&gt;World",
  ...
  describe("validateFileUpload", () => {
    ...
    it("should reject file that exceeds max size", () => {
      ...
      expect(mockCreateError).toHaveBeenCalledWith(
        "File too large. Maximum size: 10000 bytes",
        400,
      );
      expect(next).toHaveBeenCalledWith(mockError);
    });
  ...
  describe("Integration Tests", () => {
    it("should chain validation middleware correctly", () => {
      const mockValidationChain = jest.fn(
