  ...
  describe("csrfProtection middleware", () => {
    ...
    describe("HTTP Methods", () => {
      ...
      safeMethods.forEach((method) => {
        it(`should skip CSRF validation for safe ${method} requests`, () => {
      ...
      unsafeMethods.forEach((method) => {
        it(`should validate CSRF token for unsafe ${method} requests`, () => {
          mockRequest.method = method;
          mockValidateCSRFToken.mockReturnValue(true);
  ...
  describe("Middleware Integration Tests", () => {
    ...
    it("should work with different HTTP methods in sequence", () => {
      ...
      methods.forEach((method) => {
        ...
        expect(mockResponse.locals!.csrfToken).toBe(
          `csrf_${method.toLowerCase()}_token`,
        );
        expect(secondNext).toHaveBeenCalledWith();
      });
    });
