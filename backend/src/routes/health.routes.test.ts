...
describe("Health Routes", () => {
  ...
  describe("GET /api/health", () => {
    it("should return basic health status", async () => {
      (healthController.getBasicHealth as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            status: "ok",
  ...
  describe("GET /api/health/detailed", () => {
    it("should return detailed health status", async () => {
      (healthController.getDetailedHealth as jest.Mock).mockImplementation(
        (_req, res) => {
  ...
  describe("GET /api/health/ready", () => {
    it("should return ready status when services are healthy", async () => {
      (healthController.getReadiness as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            status: "ready",
            timestamp: mockHealthStatus.timestamp,
    ...
    it("should require authentication", async () => {
      ...
      await request(app).get("/api/health/ready").expect(401);
    });
  ...
  describe("GET /api/health/live", () => {
    it("should return liveness status", async () => {
      (healthController.getLiveness as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            status: "alive",
            timestamp: mockHealthStatus.timestamp,
  ...
  describe("GET /api/health/component/:component", () => {
    it("should return specific component health for database", async () => {
      (healthController.getComponentHealth as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            ...mockComponentHealth,
            component: "database",
    ...
    it("should require authentication", async () => {
      ...
      await request(app).get("/api/health/component/database").expect(401);
    });
  ...
  describe("GET /api/health/summary", () => {
    it("should return health summary", async () => {
      (healthController.getHealthSummary as jest.Mock).mockImplementation(
        (_req, res) => {
    ...
    it("should require authentication", async () => {
      ...
      await request(app).get("/api/health/summary").expect(401);
    });
  });

  describe("GET /api/health/operational", () => {
    it("should return operational status when system is healthy", async () => {
      (healthController.getOperational as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            operational: true,
            timestamp: mockHealthStatus.timestamp,
    ...
    it("should require authentication", async () => {
      ...
      await request(app).get("/api/health/operational").expect(401);
    });
  ...
  describe("GET /api/health/pool", () => {
    it("should return healthy database pool stats", async () => {
      (healthController.getDatabasePoolStats as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json(mockPoolStats);
        },
      );

      const response = await request(app).get("/api/health/pool").expect(200);
    ...
    it("should return unhealthy status when pool is saturated", async () => {
      ...
      const response = await request(app).get("/api/health/pool").expect(503);

      expect(response.body.data.healthy).toBe(false);
      expect(response.body.data.utilizationPercent).toBe(100);
      expect(response.body.data.warning).toBe(
    ...
    it("should handle database pool stats errors", async () => {
      ...
      const response = await request(app).get("/api/health/pool").expect(500);

      expect(response.body.success).toBe(false);
      expect(response.body.error).toBe(
        "Failed to get database pool statistics",
      );
    });
    ...
    it("should require authentication", async () => {
      ...
      await request(app).get("/api/health/pool").expect(401);
    });
  ...
  describe("Error Handling", () => {
    ...
    it("should handle middleware errors", async () => {
      ...
      const response = await request(app).get("/api/health/ready").expect(500);
  ...
  describe("Authentication Requirements", () => {
    ...
    it("should not require authentication for detailed health check", async () => {
      ...
      await request(app).get("/api/health/detailed").expect(200);
    });
