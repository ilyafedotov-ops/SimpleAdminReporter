...
jest.mock("@/controllers/reports.controller", () => ({
  reportsController: {
    ...
    previewCustomReport: jest.fn(),
    previewTemplate: jest.fn(),
    deleteReportExecution: jest.fn(),
    bulkDeleteReportExecutions: jest.fn(),
  },
...
describe("Reports Routes Integration", () => {
  ...
  describe("GET /api/reports/templates", () => {
    it("should return report templates", async () => {
      (reportsController.getTemplates as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
  ...
  describe("POST /api/reports/execute/:templateId", () => {
    it("should execute report template", async () => {
      (reportsController.executeTemplate as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
            data: {
  ...
  describe("GET /api/reports/fields/:source", () => {
    it("should return fields for data source", async () => {
      ...
      (reportsController.getFields as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
  ...
  describe("GET /api/reports/schema/:source/discover", () => {
    it("should discover schema for AD", async () => {
      ...
      (reportsController.discoverSchema as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
            data: mockSchema,
  ...
  describe("Custom Reports", () => {
    it("should create custom report", async () => {
      (reportsController.createCustomReport as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(201).json({
            success: true,
    ...
    it("should get custom reports", async () => {
      (reportsController.getCustomReports as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
    ...
    it("should get specific custom report", async () => {
      (reportsController.getCustomReport as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
            data: mockCustomReport,
    ...
    it("should update custom report", async () => {
      ...
      (reportsController.updateCustomReport as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
            data: updated,
    ...
    it("should delete custom report", async () => {
      (reportsController.deleteCustomReport as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
    ...
    it("should execute custom report", async () => {
      (reportsController.executeCustomReport as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
    ...
    it("should test custom query", async () => {
      (reportsController.testCustomQuery as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
  ...
  describe("Report History", () => {
    it("should get report history", async () => {
      ...
      (reportsController.getReportHistory as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
    ...
    it("should get specific report execution", async () => {
      ...
      (reportsController.getReportExecution as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
            data: execution,
    ...
    it("should get report results", async () => {
      ...
      (reportsController.getReportResults as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
    ...
    it("should get report statistics", async () => {
      ...
      (reportsController.getReportStats as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
            data: stats,
      ...
      const response = await request(app).get("/api/reports/stats").expect(200);
  ...
  describe("Query Routes", () => {
    it("should execute query", async () => {
      (queryController.executeQuery as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
    ...
    it("should build and execute query", async () => {
      (queryController.buildAndExecuteQuery as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
    ...
    it("should get query definitions", async () => {
      const definitions = [{ id: "active-users", name: "Active Users" }];

      (queryController.getQueryDefinitions as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
            data: { definitions },
  ...
  describe("Favorites Routes", () => {
    it("should get favorites", async () => {
      const favorites = [{ templateId: "template-1", type: "template" }];

      (reportsController.getFavorites as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
            data: { favorites },
    ...
    it("should add to favorites", async () => {
      (reportsController.addToFavorites as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
    ...
    it("should remove from favorites", async () => {
      (reportsController.removeFromFavorites as jest.Mock).mockImplementation(
        (_req, res) => {
          res.status(200).json({
            success: true,
  ...
  describe("Error Handling", () => {
    ...
    it("should handle validation errors", async () => {
      ...
      (handleValidationErrors as jest.Mock).mockImplementationOnce(
