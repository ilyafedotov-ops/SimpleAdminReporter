    ...
    <div>
      ...
      >
        <Form.Item
          ...
          rules={[
            { required: true, message: "Please select authentication source" },
          ]}
          style={formItemStyle}
        >
          <Select
        ...
        <Form.Item style={{ marginBottom: 0 }}>
          <Button
            ...
            style={{
              ...
              fontWeight: 500,
              background:
                selectedAuthSource === "azure" ? "#0078d4" : undefined,
              borderColor:
                selectedAuthSource === "azure" ? "#0078d4" : undefined,
            }}
          >
      ...
      {import.meta.env.DEV && (
        ...
        >
          <Text style={{ fontSize: "11px", color: "#666" }}>
            <strong>Development Mode:</strong> Demo credentials will be
