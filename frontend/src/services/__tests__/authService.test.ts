...
describe("AuthService", () => {
  ...
  beforeEach(() => {
    ...
    setIntervalSpy = vi
      ...
      .mockImplementation(() => 123 as unknown);
  ...
  describe("getCurrentAuthState", () => {
    ...
    it("should clear invalid user JSON and return unauthenticated state", () => {
      vi.mocked(localStorageMock.getItem)
  ...
  describe("setupTokenRefresh", () => {
    ...
    it("should refresh token when needed", async () => {
      ...
      const needsRefreshSpy = vi
        .spyOn(authService, "needsTokenRefresh")
